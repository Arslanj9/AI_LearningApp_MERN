    ...
    const generatePortfolio = async () => {
        try {
            ...
            const res = await api.post(
                "/api/portfolio/generate-portfolio",
        ...
        <div className="space-y-6">
            ...
            <div className="flex gap-2 border-b border-gray-200">
                <button
                    ...
                    className={`px-4 py-2 font-medium text-sm transition border-b-2 ${activeTab === 'portfolio'
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium text-sm transition border-b-2 ${activeTab === 'readme'
                            ? 'border-indigo-600 text-indigo-600'
                            : 'border-transparent text-gray-500 hover:text-gray-700'
                        }`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-2 font-medium text-sm transition border-b-2 ${activeTab === 'projects'
                            ? 'border-indigo-600 text-indigo-600'
                            : 'border-transparent text-gray-500 hover:text-gray-700'
                        }`}
                >
